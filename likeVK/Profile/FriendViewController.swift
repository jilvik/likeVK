...
//  likeVK
//
//  Created by Jambau on 26.11.2020.
//
...
class FriendViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupMessageAndAddToFriendsButtons()
        setupUserInfoLabels()
    ...
    private func setupMessageAndAddToFriendsButtons() {
        messageButton.layer.cornerRadius = 10
        addToFriendsButton.layer.cornerRadius = 10
    }
    ...
    private func enrichUser() {
        mainPhotoImageView.image = user?.profilePhoto
        ...
        if user!.degree != nil {
            degreeLabel.text = "Degree: \(user!.degree!)"
        }
        if user!.workplace != nil {
            workplaceLabel.text = "Workplace: \(user!.workplace!)"
        }
